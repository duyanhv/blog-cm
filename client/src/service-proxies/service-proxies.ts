      ...
      return response.text().then(_responseText => {
        ...
        let resultData201 =
          _responseText === ''
            ...
            : JSON.parse(_responseText, this.jsonParseReviver);
        result201 = resultData201
          ? UpdateBlogDetailDto.fromJS(resultData201)
          : new UpdateBlogDetailDto();
        return result201;
      });
    } else if (status === 400) {
      return response.text().then(_responseText => {
      ...
      return response.text().then(_responseText => {
        ...
        let resultData200 =
          _responseText === ''
            ...
            : JSON.parse(_responseText, this.jsonParseReviver);
        result200 = resultData200
          ? FindAllBlogPostsDto.fromJS(resultData200)
          : new FindAllBlogPostsDto();
        return result200;
      });
    } else if (status === 400) {
      return response.text().then(_responseText => {
  ...
  init(data?: any) {
    if (data) {
      ...
      if (data['postCreatedAt']) {
        this.postCreatedAt = {};
        for (let key in data['postCreatedAt']) {
          if (data['postCreatedAt'].hasOwnProperty(key))
            this.postCreatedAt[key] = data['postCreatedAt'][key];
        }
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (this.tags) {
      ...
      for (let key in this.tags) {
        if (this.tags.hasOwnProperty(key)) data['tags'][key] = this.tags[key];
      }
    }
    ...
    if (this.postCreatedAt) {
      data['postCreatedAt'] = {};
      for (let key in this.postCreatedAt) {
        if (this.postCreatedAt.hasOwnProperty(key))
          data['postCreatedAt'][key] = this.postCreatedAt[key];
      }
    }
    return data;
  }
