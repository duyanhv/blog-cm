...
class AboutStats extends React.Component {
    render() {
        return (
            <section id="content">
                <div id="parallax1" className="parallax text-light text-center marginbot50" 
                        ...
                        <div className="row appear stats">
                            <div className="col-xs-6 col-sm-3 col-md-3">
                                <div className="align-center color-white txt-shadow">
                                    ...
                                    <strong id="counter-coffee" className="number">1232</strong><br />
                            ...
                            <div className="col-xs-6 col-sm-3 col-md-3">
                                <div className="align-center color-white txt-shadow">
                                    ...
                                    <strong id="counter-music" className="number">345</strong><br />
                            ...
                            <div className="col-xs-6 col-sm-3 col-md-3">
                                <div className="align-center color-white txt-shadow">
                                    ...
                                    <strong id="counter-clock" className="number">501</strong><br />
                            ...
                            <div className="col-xs-6 col-sm-3 col-md-3">
                                <div className="align-center color-white txt-shadow">
                                    ...
                                    <strong id="counter-heart" className="number">378</strong><br />
