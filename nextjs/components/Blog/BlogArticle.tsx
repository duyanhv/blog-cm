      ...
      <div className="col-lg-8">
        ...
        {/* <article>
          <div className="post-image">
            <div className="post-heading">
              <h3>
                <a href="#">This is an example of standard post format</a>
              </h3>
            </div>
            <img
              src="static/img/dummies/blog/img1.jpg"
          ...
          <p>
            ...
            ea. Usu ea justo malis, pri quando everti electram ei, ex homero
            omittam salutatus sed.
          </p>
          <div className="bottom-article">
            <ul className="meta-post">
              <li>
                <i className="fa fa-calendar" />
                <a href="#"> Mar 27, 2014</a>
              </li>
              <li>
                <i className="fa fa-user" />
                <a href="#"> Admin</a>
