            ...
            <div className="col-lg-4">
                <aside className="left-sidebar">
                    ...
                    <div className="widget">
                        ...
                        <ul className="recent">
                            <li>
                                <img src="nextjs/static/img/dummies/blog/65x65/thumb1.jpg" 
                            ...
                            <li>
                                <a href="#"><img src="nextjs/static/img/dummies/blog/65x65/thumb2.jpg" 
                            ...
                            <li>
                                <a href="#"><img src="nextjs/static/img/dummies/blog/65x65/thumb3.jpg" 
                                className="pull-left" alt="" /></a>
