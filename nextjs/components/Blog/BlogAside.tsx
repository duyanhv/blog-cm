        ...
        <aside className="left-sidebar">
          ...
          <div className="widget">
            ...
            <ul className="recent">
              <li>
                <img
                  src="nextjs/static/img/dummies/blog/65x65/thumb1.jpg"
                  className="pull-left"
                  alt=""
                />
                <h6>
              ...
              <li>
                <a href="#">
                  <img
                    src="nextjs/static/img/dummies/blog/65x65/thumb2.jpg"
                    className="pull-left"
                    alt=""
                  />
                </a>
              ...
              <li>
                <a href="#">
                  <img
                    src="nextjs/static/img/dummies/blog/65x65/thumb3.jpg"
                    className="pull-left"
                    alt=""
                  />
                </a>
